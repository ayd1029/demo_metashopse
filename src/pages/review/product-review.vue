...
export default {
  ...
  methods: {
    ...
    selectContentsListMax () {
      this.$axios.get(this.$store.state.apiServerIp + '/api/review/selectProductReviewListLastPageNum',
        {params: {pageSize: this.pageSizeContents, seq_product: this.$route.query.seq}})
        .then((result) => {
    ...
    selectContentsList (idx, done) {
      this.$axios.get(this.$store.state.apiServerIp + '/api/review/selectProductReviewList',
        {params: {pageNum: idx, pageSize: this.pageSizeContents, seq_product: this.$route.query.seq}})
        .then((result) => {
          // console.log(JSON.stringify(result.data))
