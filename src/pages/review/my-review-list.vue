<template>
  <q-page class="">
    ...
    <!-- 나의 구매후기 -->
    <div id="myReview" style="width: 100%; margin: 5px 0px 0px 0px;">
      <!-- 1. 컨텐츠 리스트 -->
...
export default {
  ...
  methods: {
    ...
    selectContentsListMax () {
      this.$axios.get(this.$store.state.apiServerIp + '/api/review/selectMyReviewListLastPageNum',
    ...
    selectContentsList (idx, done) {
      this.$axios.get(this.$store.state.apiServerIp + '/api/review/selectMyReviewList',
