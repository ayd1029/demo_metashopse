  ...
  <q-page class="flex justify-center">
    ...
    <q-layout-header :reveal="$store.state.device !== 'P'">
      <q-toolbar color="black" inverted>
        ...
        <q-toolbar-title>핫딜 관리</q-toolbar-title>
    ...
    <div :style="`width: ${widthRate}%`">
      ...
      <table align="center" border="0" style="width:95%" cellpadding="3">
        <tr>
          <td align="left" width="120"><font size="3">광고비(시작가)</font></td>
          <td align="left" colspan="2"><font size="3" color="black"><b>10,000원</b> (VAT포함)</font></td>
        </tr>
        <tr>
          <td align="left"><font size="3">서비스기간</font></td>
          <td align="left" colspan="2"><font size="3" color="black"><b>1주</b> (매주 월요일 ~ 일요일)</font></td>
        </tr>
        <tr>
          <td align="left"><font size="3">노출방식</font></td>
          <td align="left" colspan="2"><font size="3" color="black"><b>가격순 정렬</b> (최고가 최상단)</font></td>
        </tr>
        <tr>
          <td align="left"><font size="3"></font></td>
          <td align="left" colspan="2"><font size="3" color="black">동순위는 <b>신청순 정렬</b></font></td>
        </tr>
        <tr>
          <td align="left"><font size="3">입금기한</font></td>
          <td align="left" colspan="2"><font size="3" color="black">핫딜 시작일 2일전</font></td>
        </tr>
      </table>
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
      ...
      <table align="center" border="0" style="width:95%" cellpadding="3">
        ...
        <tr>
          <td align="center" colspan="3">
            <q-btn dense color="primary" rounded @click="goHotdealRegister" style="width:150px; height:35px;"><font size="3">핫딜 신청</font></q-btn>
          </td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
