<template>
  <q-page class="bg-grey-2">
    ...
    <q-toolbar class="bg-grey-2" color="black" inverted>
    ...
    <div style="width: 100%; margin: 0px 0px 0px 0px;">
      ...
      <!-- 0. 버튼 -->
      <q-card inline class="q-ma-sm" style="width:95%; margin-top: 0px;">
        <table width="100%" border="0" cellspacing="0">
          <tr>
            <td width="50%" align="left">
              <q-btn @click="doPreAction('/seller/product/productRegister')" size="md" color="positive" style="width:98%; height:40px;">
                <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center">
                      <q-icon name="library_add" size="20px" />
                      &nbsp;
                      <font size="3" color="white">상품 등록</font>
                    </td>
                  </tr>
                </table>
              </q-btn>
            ...
            <td width="50%" align="right">
              <q-btn @click="doPreAction('/menu')" size="md" color="negative" style="width:98%; height:40px;">
                <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center">
                      <q-icon name="shopping_cart" size="20px" />
                      &nbsp;
                      <font size="3" color="white">구매자 홈</font>
                    </td>
                  </tr>
                </table>
              </q-btn>
      ...
      <!-- 1. 신규주문 -->
      <q-card inline class="q-ma-sm shadow-1 bg-white" style="width:95%;">
        <table width="100%" border="0" cellspacing="10">
          <tr>
            ...
            <td width="30%" align="left">
              <a @click="doPreAction('/seller/ordersList?status=01')">
      ...
      <q-card inline class="q-ma-sm shadow-1 bg-white" style="width:95%;">
        <table width="100%" border="0" cellspacing="10">
          <tr>
            ...
            <td width="30%" align="left">
              <a @click="doPreAction('/seller/ordersList?status=11')">
          ...
          <tr>
            <td align="left">
              <a @click="doPreAction('/seller/ordersList?status=12')">
          ...
          <tr>
            <td align="left">
              <a @click="doPreAction('/seller/ordersList?status=21')">
      ...
      <q-card inline class="q-ma-sm shadow-1 bg-white" style="width:95%;">
        <table width="100%" border="0" cellspacing="10">
          <tr>
            ...
            <td width="30%" align="left">
              <a @click="doPreAction('/seller/ordersList?status=03')">
          ...
          <tr>
            <td align="left">
              <a @click="doPreAction('/seller/ordersList?status=62')">
          ...
          <tr>
            <td align="left">
              <a @click="doPreAction('/seller/ordersList?status=40')">
      ...
      <table border="0" align="center">
        <tr>
          <td align="center" style="vertical-align:bottom;">
            ...
            <b>
            <font size="3" color="black">meta</font>
            <font size="3" color="#027be3">s</font>
            <font size="3" color="#34A853">h</font>
            <font size="3" color="#FBBC05">o</font>
            <font size="3" color="#EA4335">p</font>
            <font size="3" color="black">se</font>
            </b>
          </td>
        </tr>
      </table>
...
export default {
  ...
  data () {
    return {
      ...
      processTableWidth: '100%' // 판매 요약 테이블 너비 - created에서 재계산
    }
  },
  components: {
  },
  ...
  */
  created: function () {
    ...
    this.processTableWidth = (window.innerWidth - 255) / 4
