  ...
  <q-page class="flex flex-center">
    ...
    <q-layout-header :reveal="$store.state.device !== 'P'">
      <q-toolbar color="black" inverted>
        ...
        <q-toolbar-title>관리자 - 사이트맵 파일 생성</q-toolbar-title>
      </q-toolbar>
    </q-layout-header>
      ...
      <table align="center" border="0" width="85%">
        <tr>
          <td align="center" colspan="2">
            <q-btn @click="createSitemapFile" size="md" color="black" outline :style="`width:${btnWidth}%; height:48px;`">
              <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="vertical-align:middle"><font size="3" color="black">sitemap.xml 생성</font></td>
                </tr>
              </table>
            </q-btn>
          </td>
...
export default {
  ...
  methods: {
    ...
    createSitemapFile () {
      ...
      this.$axios.get(this.$store.state.apiServerIp + '/api/sitemap/createSitemapFile')
        .then((result) => {
