  ...
  <q-page class="">
    ...
    <q-layout-header>
      ...
      >
        ...
        <q-toolbar-title>전자금융거래이용약관</q-toolbar-title>
...
<br>
<br>제１조 (목적)
<br>본 약관은 (주)클레이스타(이하 ‘회사’라고 합니다)가 제공하는 전자지급결제대행서비스, 결제대금예치서비스 및 선불전자지급수단(이하 ‘원더’라고 합니다)의 발행 및 관리서비스(이하 통칭하여 ‘전자금융거래서비스’라고 합니다)를 이용자에게 제공함에 있어, 회사와 이용자간의 권리ㆍ의무 관계를 정함을 목적으로 합니다.
<br>
<br>제２조 (정의)
...
<br>
<br>제３조 (약관의 명시 및 변경)
<br>① 회사는 이용자가 전자금융거래를 하기 전에 본 약관을 회사가 운영ㆍ제공하는 “인터넷사이트(metashopse.com)” 및 “메타샵스 모바일 애플리케이션” 등(이하 통칭하여 ‘인터넷사이트 등’이라고 합니다)에 게시하고, 이용자가 본 약관이 중요한 내용을 확인할 수 있도록 합니다.
<br>② 회사는 이용자가 요청하면 전자문서를 전송(전자우편을 이용한 전송을 포함합니다)하는 방식으로 본 약관의 사본을 이용자에게 교부합니다.
<br>③ 회사는 본 약관을 변경하는 때에는 그 시행일 1월 전에 변경되는 약관을 인터넷사이트 등에 게시하여 이용자에게 고지합니다. 다만, 법령의 개정으로 인하여 긴급하게 약관을 변경한 때에는 그 변경된 약관을 인터넷사이트 등에 1개월 이상 게시하고 이용자에게 전자우편 등을 통하여 사후 통지합니다.
<br>④ 회사는 제3항에 따른 고지나 통지를 할 경우에는 “이용자가 변경에 동의하지 아니한 경우 고지나 통지를 받은 날로부터 30일 이내에 계약을 해지할 수 있으며, 계약해지의 의사표시를 하지 아니한 경우에는 변경된 약관에 동의한 것으로 본다.”라는 취지의 내용을 함께 고지하거나 통지합니다.
...
<br>②    회사는 정보통신설비의 보수, 점검 및 그 밖의 기술상 필요나 금융회사 및 그 밖의 결제수단 발행업자 사정에 따라 전자금융거래 서비스 중단이 불가피한 경우에는 해당 서비스 중단 3일 전까지 게시 가능한 전자적 수단을 통하여 해당 서비스 중단 사실을 게시한 후 해당 서비스를 일시 중단할 수 있습니다. 다만, 시스템 장애복구, 긴급한 프로그램 보수, 외부요인 등 불가피한 경우에는 사전 게시 없이 전자금융거래 서비스를 중단할 수 있습니다.
<br>
<br>제６조  (접근매체의 관리)
...
<br>
<br>제７조 (거래내용의 확인)
<br>① 회사는 인터넷사이트 등에 해당 서비스 조회 화면을 통하여 이용자가 자신의 거래내용(이용자의 ‘오류정정 요구사실 및 처리결과에 관한 사항’을 포함합니다)을 확인할 수 있도록 합니다. 이 경우 전자적 장치의 운영장애 또는 그 밖의 사유로 거래내용을 확인하게 할 수 없는 때에는 회사는 인터넷사이트 등을 이용하여 즉시 그 사유를 알리고, 그 사유가 종료된 때부터 이용자가 자신의 거래내용을 확인할 수 있도록 합니다.
...
<br>③ 회사는 제2항에 따라 이용자로부터 거래내용에 관한 서면교부를 요청받았으나 전자적 장치의 운영장애 또는 그 밖의 사유로 거래내용에 관한 서면을 교부할 수 없는 경우에는 해당 이용자에게 즉시 그 사실 및 사유를 알립니다. 이 경우 전자적 장치의 운영장애 또는 그 밖의 사유로 거래내용에 관한 서면을 교부할 수 없는 기간은 제2항에 따른 거래내용에 관한 서면의 교부기간에 산입하지 아니합니다.
...
<br>1. 접근매체의 위조나 변조로 발생한 사고(단, 회사가 접근매체의 발급주체이거나 사용ㆍ관리주체인 경우)
...
<br>6. 회사가 이용자로부터 선불전자지급수단의 분실 또는 도난의 통지를 받기 전에 저장된 금액에 대한 손해인 경우
<br>7. 천재지변, 전쟁, 테러 또는 회사의 귀책사유 없이 발생한 정전, 화재, 건물의 훼손 등 불가항력으로 인한 경우
...
<br>제１９조 (정의)
<br>본 장에서 정하는 용어의 정의는 다음과 같습니다.
<br>1. “선불전자지급수단”이라 함은 인터넷사이트 등에서 이용되는 원더 등 회사가 발행 당시 미리 이용자에게 공지한 전자금융거래법상 선불전자지급수단을 말합니다.
<br>2. “원더”라 함은 이용자가 인터넷사이트 등에 입점한 판매자로부터 재화 등을 구매하고 그 대가를 지급하는데 사용하기 위하여 회사가 발행ㆍ관리하는 선불전자지급수단을 말하고, 그 발행최고한도는 기명식 200만원, 무기명식 50만원으로 합니다
...
<br>
<br>제２１조 (환급)
<br>① 환급의 대상이 되는 선불전자지급수단은 이용자가 회사로부터 구매하여 보유하고 있는 것에 한정되며, 이용자가 이벤트, 미사용쿠폰 등에 대한 환불 등을 통하여 회사로부터 무상 제공받은 것은 포함되지 않습니다.
<br>② 회사는 다음 각 호의 어느 하나에 해당하는 경우에는 이용자에게 그 이용자가 보유 중인 선불전자지급수단의 전액에서 수수료를 공제한 나머지 금액 전부를 환급하여 줍니다.
<br>1. 천재지변 등의 사유로 인하여 회사 또는 판매자의 재화 또는 용역제공이 불가능한 경우
<br>2. 이용자가 선불전자지급수단의 결함으로 회사 또는 판매자로부터 재화 또는 용역을 제공받지 못하는 경우
<br>3. 이용자가 회사로부터 구매하여 보유 중인 선불전자지급수단 금액의 80%이상 사용하고 남은 잔액에 대하여 환급을 요청한 경우
<br>
<br>제２２조 (환수)
