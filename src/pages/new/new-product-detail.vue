  ...
  <q-page class="flex justify-center">
    ...
    <q-layout-header :reveal="$store.state.device !== 'P'">
      <q-toolbar color="black" inverted>
        ...
        <q-toolbar-title>{{ productVo.title }}</q-toolbar-title>
        <q-btn v-if="$store.state.device !== 'P'" flat round dense icon="home" @click="goHome" />
    ...
    <div :style="`width: ${widthRate}%`">
      ...
      <q-list link>
        <table width="100%" border="0">
          ...
          <tr>
            <td colspan="2" style="text-align:left; word-break:keep-all; word-wrap:break-word;">
  ...
  methods: {
    ...
    */
    ...
    addToFavorite () {
      // 로그인 체크
      if (!this.checkLogin()) {
        // this.$store.state.nextActionAfterLogin = 'addToFavorite'
        // this.$store.state.nextPathAfterLogin = '/new/newProductDetail?seq=' + this.$route.query.seq
        this.$refs.loginModal.redirectTo = '/new/newProductDetail?seq=' + this.$route.query.seq
        this.$refs.loginModal.show()
        return
    ...
    goBuy () {
      // 로그인 체크
      if (!this.checkLogin()) {
        // this.$store.state.nextActionAfterLogin = 'goBuy'
        // this.$store.state.nextPathAfterLogin = '/new/newProductDetail?seq=' + this.$route.query.seq
